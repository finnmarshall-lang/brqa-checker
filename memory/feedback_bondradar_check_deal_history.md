...
metadata:
  ...
  modified: 2026-08-27T06:57:35.417Z
---
...
4. Only if NO prior message contains that language → propose `Books last heard over`.
5. Same logic for `additionalInfo` on the priced-deal form: only populate with `Books last heard over` when the deal genuinely never had final/closed language.
